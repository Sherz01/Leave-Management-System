...
namespace Leave_Management_System.Data.Migrations
{
    ...
    [Migration("20210817132442_periodAlloVM")]
    partial class periodAlloVM
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Leave_Management_System.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_System.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_System.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_System.Models.LeaveTypeVM", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_System.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("Leave_Management_System.Data.LeaveAllocation", b =>
                {
                    b.HasOne("Leave_Management_System.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Leave_Management_System.Data.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Leave_Management_System.Data.LeaveHistory", b =>
                {
                    b.HasOne("Leave_Management_System.Data.Employee", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("Leave_Management_System.Data.Employee", "RequestingEmployee")
                        .WithMany()
